...
class MYGenerativeAgentMemory(BaseMemory):
    ...
    def _score_memory_importance(self, memory_content: str) -> float:
        ...
        prompt = PromptTemplate.from_template(
            "On the scale of 1 to 10, where 1 is purely mundane"
            + " (e.g., unrelated to Sam's personal or professional interests) and 10 is"
            + " extremely poignant (e.g., related to work meetings or projects, related to Sam's hobbies or interests"
            + " appointments), rate the likely poignancy of the"
    ...
    def reflection_test(self, now: Optional[datetime] = None):
        self.reflecting = True
        self.pause_to_reflect(now=now)
        # Hack to clear the importance from reflection
        self.aggregate_importance = 0.0
