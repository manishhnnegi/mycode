...
#-------------------------------------------------------
batch_size = 4
block_size = 8 # max input seq_len(context len)
...
lr = 3e-4
n_embd = 100 # embed vector dim (channel)
n_head = 2 # 100 / 2 = 3 each (vect div in 2 parts of each 3dims)
n_layer = 2 # no of block used in decoder 
dropout = 0.2
